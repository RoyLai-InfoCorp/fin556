...
async function getPairAddress(token0, token1, factory) {
...
async function main() {
  ...
  const token1 = await ethers.getContractAt("DemoTokenB", addresses.token1);
  ...
  const pairAddress2 = await getPairAddress(token0, token1, factory);
